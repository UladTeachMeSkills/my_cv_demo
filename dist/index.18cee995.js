...
})({"hhiuw":[function(require,module,exports) {
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    for(var i = 0; i < paths.length; i++){
        var path = paths[i];
        var offset = (0, _animeEsJsDefault.default).setDashoffset(path);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hhiuw","8eFH3"], "8eFH3", "parcelRequire13fe")
